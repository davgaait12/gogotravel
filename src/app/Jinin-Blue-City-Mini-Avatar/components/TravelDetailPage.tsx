...
const TravelDetailMongolian = () => {
  ...
  const tourData: TourData = {
    ...
    mainImage: "/img/miniavatarapark.jpg",
    ...
    description:
      "Жинин-Хөх хот-Мини Аватар аялалд хамрагдаж, Жинин хотын 33 төрлийн халуун рашаан бүхий WATER WORLD алжаал тайлах амралтын цогцолбор, Мини Аватар усан парк, Хөх хотын Шинжлэх ухааны музей болон Хүүхдийн шинжлэх ухааны парк, Технологын музей зэрэг газруудаар аялах болно.",
    ...
    itinerary: [
      ...
      {
        day: 3,
        title: "Өдөр 3 - Жинин-Мини Аватар-Хөх хот",
        activities: [
          { name: "Өглөөний цай-буфет", icon: "☕" },
          {
            name: "Жинин хотоос аяллын автобусаар Мини аватар руу хөдлөх (2 цаг)",
            icon: "🚌",
          },
