...
const Footer: React.FC<FooterProps> = ({
  contactInfo = {
    address:
      "Ulaanbaatar city, on the east side of Sukhbaatar Square, Tsagaan Lav No. 622",
    phone: "+976 80113295",
  ...
  navigationLinks = ["Foreign Travel", "Domestic Travel", "Information"],
  copyright = "© 2025 GoGo Travel. All rights reserved.",
}) => {
  return (
